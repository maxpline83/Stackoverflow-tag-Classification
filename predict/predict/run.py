...
class TextPredictionModel:
    ...
    def from_artefacts(cls, artefacts_path: str):
        ...
        # TODO: CODE HERE
        # load params
        with open(os.path.join(artefacts_path, "params.json"), 'r') as params_file:
            params = json.load(params_file)

        # TODO: CODE HERE
        # load labels_to_index
        with open(os.path.join(artefacts_path, "labels_index.json"), "r") as labels_file:
    ...
    def predict(self, text_list, top_k=5):
        ...
        predictions = self.model.predict(embed_text)
